...
pub static REGISTRY: &[ConstantEntry] = &[
    ...
    ConstantEntry {
        ...
        env_override: Some("EGOFF_COCKPIT_HOST_TEMPERATURE_K"),
    },
    ConstantEntry {
    ...
    ConstantEntry {
        ...
        env_override: Some("EGOFF_COCKPIT_STALENESS_CYCLES"),
    },
    ConstantEntry {
    ...
    ConstantEntry {
        ...
        env_override: Some("EGOFF_COCKPIT_MAX_DELTA_MI_BITS"),
    },
    ConstantEntry {
        ...
        env_override: Some("EGOFF_COCKPIT_WEIGHT_* (six vars)"),
    },
    ConstantEntry {
    ...
    ConstantEntry {
        ...
        env_override: Some("EGOFF_COCKPIT_AUDIT_ROTATIONS"),
    },
    ConstantEntry {
    ...
    ConstantEntry {
        ...
        env_override: Some("EGOFF_COCKPIT_HTTP_CORS_OPEN"),
    },
    ConstantEntry {
        name: "egoff_discovery_refresh_secs",
        ...
        env_override: Some("EGOFF_DISCOVERY_REFRESH_SECS"),
    },
    ConstantEntry {
        name: "egoff_tool_timeout_secs",
        ...
        env_override: Some("EGOFF_TOOL_TIMEOUT_SECS"),
    },
    ConstantEntry {
        ...
        env_override: Some("EGOFF_COCKPIT_AUDIT_MAX_BYTES"),
    },
    ConstantEntry {
    ...
    ConstantEntry {
        ...
        tier: ConstantTier::Tier4Infra,
        evidence: "Design default per COCKPIT brief; EGOFF_EMBEDDING_TIMEOUT_SECONDS not yet wired in adapters (2026-04-21)",
        env_override: Some("EGOFF_EMBEDDING_TIMEOUT_SECONDS"),
    },
    ConstantEntry {
    ...
    ConstantEntry {
        name: "egoff_haskell_toolchain_reference",
        ...
        env_override: Some("EGOFF_NATIVE_GHC"),
    },
    ConstantEntry {
        name: "egoff_energy_backend",
        ...
        env_override: Some("EGOFF_ENERGY_BACKEND"),
    },
    ConstantEntry {
        name: "egoff_epistemic_proxy_estimator",
        ...
        env_override: Some("EGOFF_EPISTEMIC_PROXY_ESTIMATOR"),
    },
    ConstantEntry {
    ...
    ConstantEntry {
        name: "egoff_discovery_lru_capacity",
        expression: "16 (model discovery LRU; §14bis.e TUI-5; EGOFF_DISCOVERY_LRU_CAPACITY; operator capacity bound)",
        tier: ConstantTier::Tier3Policy,
        evidence: "Definition (HSAD §0.12; §14bis.e TUI-5; B-extend cache; REGISTRY-witnessed)",
        env_override: Some("EGOFF_DISCOVERY_LRU_CAPACITY"),
    },
    ConstantEntry {
        name: "egoff_llm_chain_mode",
        ...
        env_override: Some("EGOFF_LLM_CHAIN_MODE"),
    },
    ConstantEntry {
        name: "egoff_orchestration_intent_text_fold",
    ...
    ConstantEntry {
        name: "egoff_tui_render_debounce_ms",
        expression: "16 (TUI telemetry coalescing window; §14bis.e TUI-5; EGOFF_TUI_RENDER_DEBOUNCE_MS; 1..=1000ms clamp in egoff tui runtime)",
        tier: ConstantTier::Tier3Policy,
        evidence: "Definition (HSAD §0.12; §14bis.e TUI-5; coalesces idle redraws; keystroke fast path stays immediate)",
        env_override: Some("EGOFF_TUI_RENDER_DEBOUNCE_MS"),
    },
    ConstantEntry {
        name: "egoff_semantic_coverage_threshold_w2",
        expression: "40% (first `check_semantic_coverage.sh` floor; wide gate G8; W-2 10% → W-3 20% → W-4' 30% → W-5 40%; W-6+)",
        tier: ConstantTier::Tier3Policy,
        evidence: "Definition (HSAD §0.12 candidate; §14bis.l W-2/W-3/W-4-H7-stop/W-4'/W-5); G8 binds `EGOFF_SEMANTIC_THRESHOLD` to this row’s policy intent",
        env_override: Some("EGOFF_SEMANTIC_THRESHOLD"),
    },
    // CONSTANT-BOUND: `egoff_gpu_backend_default` (Tier-3 honest disclosure; expression names default n/a)
    ConstantEntry {
        name: "egoff_gpu_backend_default",
        expression: "n/a (string policy default; unset or EGOFF_GPU_BACKEND=n/a → CockpitSnapshot.gpu_backend None; §0.5 NED)",
        tier: ConstantTier::Tier3Policy,
        evidence: "Definition (HSAD §0.12; §14bis.e TUI-6a + §14bis.f H-6a; no fabricated GPU energy reading)",
        env_override: Some("EGOFF_GPU_BACKEND"),
    },
    // CONSTANT-BOUND: `egoff_h3b_reward_*` — H-3b witness telemetry (FORWARD-PLAN §3.1; not production training)
    ConstantEntry {
        name: "egoff_h3b_reward_alpha",
    ...
    ConstantEntry {
        name: "egoff_h3b_reward_gamma",
        expression: "0.2 (energy slack weight γ)",
        tier: ConstantTier::Tier3Policy,
        evidence: "Definition (§14bis.f-H-3b Path B witness reward bridge)",
        env_override: None,
    },
    // CONSTANT-BOUND: `egoff_npu_backend_default` (Tier-3 honest disclosure; expression names default n/a)
    ConstantEntry {
        name: "egoff_npu_backend_default",
        expression: "n/a (string policy default; unset or EGOFF_NPU_BACKEND=n/a → CockpitSnapshot.npu_backend None; §0.5 NED)",
        tier: ConstantTier::Tier3Policy,
        evidence: "Definition (HSAD §0.12; §14bis.e TUI-6a + §14bis.f H-6a; no fabricated NPU energy reading)",
        env_override: Some("EGOFF_NPU_BACKEND"),
    },
    // CONSTANT-BOUND: `egoff_closed_loop_rcc_accept_tick` (Tier-3 RCC policy per accept; egoffplan §0.4 CGD)
    ConstantEntry {
        name: "egoff_closed_loop_rcc_accept_tick",
    ...
    // CONSTANT-BOUND: `egoff_cockpit_smoothing_default` (TUI-7 EKF / Kalman / none; REGISTRY string policy)
    ConstantEntry {
        name: "egoff_cockpit_smoothing_default",
        expression: "ekf (string policy; EGOFF_COCKPIT_SMOOTHING ∈ {ekf, kalman, none}; per-metric [`MetricSmoother`] bundle on CockpitHub::sample_now)",
        tier: ConstantTier::Tier3Policy,
        evidence: "Definition (HSAD §0.12; §14bis.e TUI-7; `umst-math::smoothing` vendor umst-prototype-2a; :explain raw+smoothed+variance)",
        env_override: Some("EGOFF_COCKPIT_SMOOTHING"),
    },
    ...
    ConstantEntry {
        name: "egoff_smoother_r_rcc",
        expression: "3180.0 (measurement noise R for rcc lane; method (b); SEQ0; see companion Q row evidence)",
        tier: ConstantTier::Tier1Measurement,
        evidence: "TUI-7 `smoothing_{ekf,kalman}_e_bisim` SEQ0; umst-prototype-2a@9c0434d3; method (b) as `egoff_smoother_q_rcc`",
        env_override: None,
    },
    ConstantEntry {
        name: "egoff_smoother_q_mi",
    ...
    ConstantEntry {
        name: "egoff_smoother_q_landauer_slack",
    ...
    ConstantEntry {
        name: "egoff_smoother_r_landauer_slack",
    ...
    ConstantEntry {
        name: "egoff_tui_color_accent_dark",
        expression: "#00FFFF sRGB; TUI-6b **dark** accent (header, sparkline); `tui(Slot::Accent, Dark)`",
        tier: ConstantTier::Tier3Policy,
        evidence: "Definition (HSAD §0.12; §14bis.e TUI-6b; EGOFF_TUI_THEME; COCKPIT_DESIGN_BRIEF Theme+keybindings)",
        env_override: None,
    },
    ConstantEntry {
        name: "egoff_tui_color_accent_light",
    ...
    ConstantEntry {
        name: "egoff_tui_color_body_dark",
    ...
    ConstantEntry {
        name: "egoff_tui_color_body_light",
    ...
    ConstantEntry {
        name: "egoff_tui_color_gauge_dark",
    ...
    ConstantEntry {
        name: "egoff_tui_color_gauge_light",
    ...
    ConstantEntry {
        name: "egoff_tui_color_input_prompt_dark",
    ...
    ConstantEntry {
        name: "egoff_tui_color_input_prompt_light",
    ...
    ConstantEntry {
        name: "egoff_tui_color_level_green_dark",
    ...
    ConstantEntry {
        name: "egoff_tui_color_level_green_light",
    ...
    ConstantEntry {
        name: "egoff_tui_color_level_orange_dark",
    ...
    ConstantEntry {
        name: "egoff_tui_color_level_orange_light",
    ...
    ConstantEntry {
        name: "egoff_tui_color_level_red_dark",
    ...
    ConstantEntry {
        name: "egoff_tui_color_level_red_light",
    ...
    ConstantEntry {
        name: "egoff_tui_color_level_teal_dark",
    ...
    ConstantEntry {
        name: "egoff_tui_color_level_teal_light",
    ...
    ConstantEntry {
        name: "egoff_tui_color_level_unknown_dark",
    ...
    ConstantEntry {
        name: "egoff_tui_color_level_unknown_light",
    ...
    ConstantEntry {
        name: "egoff_tui_color_level_yellow_dark",
    ...
    ConstantEntry {
        name: "egoff_tui_color_level_yellow_light",
    ...
    ConstantEntry {
        name: "egoff_tui_color_muted_dim_dark",
    ...
    ConstantEntry {
        name: "egoff_tui_color_muted_dim_light",
    ...
    ConstantEntry {
        name: "egoff_tui_color_status_muted_dark",
    ...
    ConstantEntry {
        name: "egoff_tui_color_status_muted_light",
    ...
    ConstantEntry {
        name: "egoff_memory_default_resolution_bits",
    ...
    ConstantEntry {
        name: "egoff_memory_inspect_runtime_us_p99",
    ...
    ConstantEntry {
        name: "egoff_memory_load_runtime_us_p99",
    ...
    ConstantEntry {
        name: "egoff_memory_local_tier_size_typical",
    ...
    ConstantEntry {
        name: "egoff_memory_schema_version",
    ...
    ConstantEntry {
        name: "egoff_memory_store_runtime_us_p99",
    ...
    ConstantEntry {
        name: "egoff_memory_m2_promote_ceremony_atomic",
    ...
    ConstantEntry {
        name: "egoff_memory_m2_sanitize_serial_kinds_count",
    ...
    ConstantEntry {
        name: "egoff_memory_merge_safe_attestation_wire_version",
    ...
    ConstantEntry {
        name: "egoff_memory_schema_version_v2",
        expression:
    ...
    ConstantEntry {
        name: "egoff_memory_tier_repr_byte_device",
        expression:
    ...
    ConstantEntry {
        name: "egoff_memory_tier_repr_byte_ephemeral",
    ...
    ConstantEntry {
        name: "egoff_memory_tier_repr_byte_federated",
        expression:
    ...
    ConstantEntry {
        name: "egoff_memory_retention_alpha_default",
        expression:
    ...
    ConstantEntry {
        name: "egoff_memory_retention_pareto_compute_p99_us",
    ...
    ConstantEntry {
        name: "egoff_manifold_liquid_ppo_witness_default",
        expression: "0 (witness off; EGOFF_MANIFOLD_LIQUID_PPO_WITNESS unset → no Path B step_and_learn on accept)",
        tier: ConstantTier::Tier3Policy,
        evidence: "Definition (MANIFOLD-INTEGRATION-ADR; §14bis.f-H-3b; `ppo_witness_enabled` truthy_env only)",
        env_override: Some("EGOFF_MANIFOLD_LIQUID_PPO_WITNESS"),
    },
    ConstantEntry {
        name: "egoff_manifold_ppo_info_gain_default_bits",
        expression: "0.01 (default MI tensor scale when EGOFF_MANIFOLD_GATEWAY_INFO_GAIN_BITS unset)",
        tier: ConstantTier::Tier3Policy,
        evidence: "Definition (§14bis.f-I-4; `ppo_info_gain_bits`; proposal-length fallback when unset)",
        env_override: Some("EGOFF_MANIFOLD_GATEWAY_INFO_GAIN_BITS"),
    },
    ConstantEntry {
        name: "egoff_manifold_emergence_lambda",
        expression: "0.1 (EmergenceMonitor λ; `EGOFF_MANIFOLD_EMERGENCE_LAMBDA` when unset)",
        tier: ConstantTier::Tier3Policy,
        evidence: "Definition (§14bis.f-I-5 / §14bis.f-M-SDF-emergence; `emergence_lambda`)",
        env_override: Some("EGOFF_MANIFOLD_EMERGENCE_LAMBDA"),
    },
    ConstantEntry {
        name: "egoff_msdf_emergence_max_voxels",
        ...
        env_override: Some("EGOFF_MSDF_EMERGENCE_MAX_VOXELS"),
    },
    ConstantEntry {
        name: "egoff_ucrs_memory_phase_bind_enabled",
        expression: "0 (default off; `EGOFF_UCRS_MEMORY_PHASE_BIND=1` enables accept-path bind)",
        tier: ConstantTier::Tier3Policy,
        evidence: "Definition (§14bis.x-M-UCRS-SDF-TIME; `ucrs_memory_bind_enabled`; umst_ucrs `phase_entropy_bits`)",
        env_override: Some("EGOFF_UCRS_MEMORY_PHASE_BIND"),
    },
    ConstantEntry {
        name: "egoff_msdf_layer_stack_max_depth",
        expression: "4 (ring cap when `EGOFF_MSDF_LAYER_STACK=1` + emergence grid on)",
        tier: ConstantTier::Tier3Policy,
        evidence: "Definition (§14bis.x-M-UCRS-SDF-TIME; `msdf_layer_stack_max_depth`)",
        env_override: Some("EGOFF_MSDF_LAYER_STACK_MAX_DEPTH"),
    },
    ConstantEntry {
        name: "egoff_memory_observed_wall_ms_source",
    ...
    ConstantEntry {
        name: "egoff_memory_cockpit_badge_format",
    ...
    ConstantEntry {
        name: "egoff_manifold_introspect_enabled",
        expression: "0 (`EGOFF_MANIFOLD_INTROSPECT=1` adds verbose :manifold lines only)",
        tier: ConstantTier::Tier3Policy,
        evidence: "Definition (§14bis.f-M-6; `manifold_introspect_verbose_enabled`)",
        env_override: Some("EGOFF_MANIFOLD_INTROSPECT"),
    },
    ConstantEntry {
        name: "egoff_mcert_strict_paired_default",
        expression: "0 (`egoff mcert --paired` / `:mcert --paired` opt-in heavy scripts)",
        tier: ConstantTier::Tier3Policy,
        evidence: "Definition (§14bis.f-M-7; `run_mcert_paired`)",
        env_override: Some("EGOFF_MCERT_STRICT_PAIRED"),
    },
    ConstantEntry {
        name: "egoff_action_shape_canonicalize_kind",
    ...
    ConstantEntry {
        name: "egoff_action_shape_quotient_default_enabled",
        expression: "1 (merge credits by intrinsic geometry key; `0` disables)",
        tier: ConstantTier::Tier3Policy,
        evidence: "Definition (§14bis.f-M-4; `EGOFF_ACTION_SHAPE_QUOTIENT`)",
        env_override: Some("EGOFF_ACTION_SHAPE_QUOTIENT"),
    },
    ConstantEntry {
        name: "egoff_action_shape_palette_max_entries_default",
        expression: "100",
        tier: ConstantTier::Tier3Policy,
        evidence: "Definition (§14bis.f-M-4 `:action-shapes`; palette truncation)",
        env_override: Some("EGOFF_ACTION_SHAPE_PALETTE_MAX_ENTRIES"),
    },
    ...
    ConstantEntry {
        name: "egoff_llm_tier_fallback_default_chain_gemini",
        expression: "gemini-3.1-pro-preview,gemini-2.5-pro,gemini-2.0-flash,gemini-1.5-flash (comma-separated model ids)",
        tier: ConstantTier::Tier3Policy,
        evidence: "Definition (§14bis.l-LHF-5; default Gemini tier fold; override EGOFF_LLM_TIER_FALLBACK_CHAIN_GEMINI)",
        env_override: Some("EGOFF_LLM_TIER_FALLBACK_CHAIN_GEMINI"),
    },
    ConstantEntry {
        name: "egoff_llm_tier_degradation_event_kind",
...
/// Used for TUI-7b per-metric Joseph/Kalman covariances (`egoff_smoother_{q,r}_*`).
#[must_use]
