...
| `hex_pcg_max_iter_default_striatus` | `hex_elasticity::HEX_PCG_MAX_ITER_DEFAULT_STRIATUS` | topology / voigt |
| `hex_pcg_rel_tol_f32` | `hex_elasticity::HEX_PCG_REL_TOL_F32` | topology / voigt |
| `hex_pcg_rel_tol_f64` | `hex_elasticity::HEX_PCG_REL_TOL_F64` | topology / voigt |
