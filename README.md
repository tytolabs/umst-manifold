...
<p align="center"><img src="https://latex.codecogs.com/svg.image?%5Cdpi%7B150%7D%5Cbg_white&space;\partial_p%20\circ%20\partial_{p+1}%20=%200%20\quad%20\Longleftrightarrow%20\quad%20d^{p+1}%20\circ%20d^p%20=%200#gh-light-mode-only" alt="\partial_p \circ \partial_{p+1} = 0 \quad \Longleftrightarrow \quad d^{p+1} \cir…"/><img src="https://latex.codecogs.com/svg.image?%5Cdpi%7B150%7D%5Cbg_black%5Ccolor%7Bwhite%7D&space;\partial_p%20\circ%20\partial_{p+1}%20=%200%20\quad%20\Longleftrightarrow%20\quad%20d^{p+1}%20\circ%20d^p%20=%200#gh-dark-mode-only" alt="\partial_p \circ \partial_{p+1} = 0 \quad \Longleftrightarrow \quad d^{p+1} \cir…"/></p>
...
<p align="center"><img src="https://latex.codecogs.com/svg.image?%5Cdpi%7B150%7D%5Cbg_white&space;\Delta%20E%20\geq%20k_B%20T%20\ln%202#gh-light-mode-only" alt="\Delta E \geq k_B T \ln 2"/><img src="https://latex.codecogs.com/svg.image?%5Cdpi%7B150%7D%5Cbg_black%5Ccolor%7Bwhite%7D&space;\Delta%20E%20\geq%20k_B%20T%20\ln%202#gh-dark-mode-only" alt="\Delta E \geq k_B T \ln 2"/></p>
...
<p align="center"><img src="https://latex.codecogs.com/svg.image?%5Cdpi%7B150%7D%5Cbg_white&space;\theta%20\gamma%20=%20\theta%20\dot{s}%20-%20\dot{u}%20+%20\frac{1}{\rho}\boldsymbol{\sigma}:\mathbf{d}%20-%20\frac{1}{\rho\theta}\mathbf{q}\cdot\nabla\theta%20\geq%200#gh-light-mode-only" alt="\theta \gamma = \theta \dot{s} - \dot{u} + \frac{1}{\rho}\boldsymbol{\sigma}:\ma…"/><img src="https://latex.codecogs.com/svg.image?%5Cdpi%7B150%7D%5Cbg_black%5Ccolor%7Bwhite%7D&space;\theta%20\gamma%20=%20\theta%20\dot{s}%20-%20\dot{u}%20+%20\frac{1}{\rho}\boldsymbol{\sigma}:\mathbf{d}%20-%20\frac{1}{\rho\theta}\mathbf{q}\cdot\nabla\theta%20\geq%200#gh-dark-mode-only" alt="\theta \gamma = \theta \dot{s} - \dot{u} + \frac{1}{\rho}\boldsymbol{\sigma}:\ma…"/></p>
...
*   **Thermodynamically Gated Rewards:** The verified state is assigned a scalar reward computed on-device using a balanced physical-chemical objective:
    ...
    <p align="center"><img src="https://latex.codecogs.com/svg.image?%5Cdpi%7B150%7D%5Cbg_white&space;R%20=%20\alpha%20\cdot%20\text{Free%20Energy}%20-%20\beta%20\cdot%20\text{Dissipation}%20-%20\gamma%20\cdot%20\text{Carbon%20Cost}%20-%20\text{Erasure%20Cost}#gh-light-mode-only" alt="R = \alpha \cdot \text{Free Energy} - \beta \cdot \text{Dissipation} - \gamma \c…"/><img src="https://latex.codecogs.com/svg.image?%5Cdpi%7B150%7D%5Cbg_black%5Ccolor%7Bwhite%7D&space;R%20=%20\alpha%20\cdot%20\text{Free%20Energy}%20-%20\beta%20\cdot%20\text{Dissipation}%20-%20\gamma%20\cdot%20\text{Carbon%20Cost}%20-%20\text{Erasure%20Cost}#gh-dark-mode-only" alt="R = \alpha \cdot \text{Free Energy} - \beta \cdot \text{Dissipation} - \gamma \c…"/></p>
...
*   **Exact Tensor Formulation:** Solves the coupled Poisson-Boltzmann-Nernst-Planck (PBNP) system:
    ...
    <p align="center"><img src="https://latex.codecogs.com/svg.image?%5Cdpi%7B150%7D%5Cbg_white&space;\frac{\partial%20C_i}{\partial%20t}%20=%20\nabla%20\cdot%20\left(%20D_i%20\nabla%20C_i%20+%20\frac{z_i%20F%20D_i}{R%20T}%20C_i%20\nabla%20\Phi%20\right)%20-%20\mathbf{u}%20\cdot%20\nabla%20C_i#gh-light-mode-only" alt="\frac{\partial C_i}{\partial t} = \nabla \cdot \left( D_i \nabla C_i + \frac{z_i…"/><img src="https://latex.codecogs.com/svg.image?%5Cdpi%7B150%7D%5Cbg_black%5Ccolor%7Bwhite%7D&space;\frac{\partial%20C_i}{\partial%20t}%20=%20\nabla%20\cdot%20\left(%20D_i%20\nabla%20C_i%20+%20\frac{z_i%20F%20D_i}{R%20T}%20C_i%20\nabla%20\Phi%20\right)%20-%20\mathbf{u}%20\cdot%20\nabla%20C_i#gh-dark-mode-only" alt="\frac{\partial C_i}{\partial t} = \nabla \cdot \left( D_i \nabla C_i + \frac{z_i…"/></p>
    
    <p align="center"><img src="https://latex.codecogs.com/svg.image?%5Cdpi%7B150%7D%5Cbg_white&space;\epsilon%20\nabla^2%20\Phi%20=%20-%20\sum%20z_i%20F%20C_i#gh-light-mode-only" alt="\epsilon \nabla^2 \Phi = - \sum z_i F C_i"/><img src="https://latex.codecogs.com/svg.image?%5Cdpi%7B150%7D%5Cbg_black%5Ccolor%7Bwhite%7D&space;\epsilon%20\nabla^2%20\Phi%20=%20-%20\sum%20z_i%20F%20C_i#gh-dark-mode-only" alt="\epsilon \nabla^2 \Phi = - \sum z_i F C_i"/></p>
...
*   **Exact Tensor Formulation:** Implements a Finite-Difference Frequency-Domain (FDFD) formulation of Maxwell’s curl equations:
    ...
    <p align="center"><img src="https://latex.codecogs.com/svg.image?%5Cdpi%7B150%7D%5Cbg_white&space;\nabla%20\times%20\left(%20\mu_r^{-1}%20\nabla%20\times%20\mathbf{E}%20\right)%20-%20k_0^2%20\epsilon_r%20\mathbf{E}%20=%20-%20i%20\omega%20\mu_0%20\mathbf{J}#gh-light-mode-only" alt="\nabla \times \left( \mu_r^{-1} \nabla \times \mathbf{E} \right) - k_0^2 \epsilo…"/><img src="https://latex.codecogs.com/svg.image?%5Cdpi%7B150%7D%5Cbg_black%5Ccolor%7Bwhite%7D&space;\nabla%20\times%20\left(%20\mu_r^{-1}%20\nabla%20\times%20\mathbf{E}%20\right)%20-%20k_0^2%20\epsilon_r%20\mathbf{E}%20=%20-%20i%20\omega%20\mu_0%20\mathbf{J}#gh-dark-mode-only" alt="\nabla \times \left( \mu_r^{-1} \nabla \times \mathbf{E} \right) - k_0^2 \epsilo…"/></p>
...
*   **Exact Tensor Formulation:** Solves the coupled mechanical displacement and crack phase-field equations:
    ...
    <p align="center"><img src="https://latex.codecogs.com/svg.image?%5Cdpi%7B150%7D%5Cbg_white&space;\left[%20(1-d)^2%20+%20\kappa%20\right]%20\nabla%20\cdot%20\boldsymbol{\sigma}_0%20=%20\mathbf{0}#gh-light-mode-only" alt="\left[ (1-d)^2 + \kappa \right] \nabla \cdot \boldsymbol{\sigma}_0 = \mathbf{0}"/><img src="https://latex.codecogs.com/svg.image?%5Cdpi%7B150%7D%5Cbg_black%5Ccolor%7Bwhite%7D&space;\left[%20(1-d)^2%20+%20\kappa%20\right]%20\nabla%20\cdot%20\boldsymbol{\sigma}_0%20=%20\mathbf{0}#gh-dark-mode-only" alt="\left[ (1-d)^2 + \kappa \right] \nabla \cdot \boldsymbol{\sigma}_0 = \mathbf{0}"/></p>
    
    <p align="center"><img src="https://latex.codecogs.com/svg.image?%5Cdpi%7B150%7D%5Cbg_white&space;G_c%20\left(%20-l%20\nabla^2%20d%20+%20\frac{d}{l}%20\right)%20=%202(1-d)\mathcal{H}(\boldsymbol{\epsilon})#gh-light-mode-only" alt="G_c \left( -l \nabla^2 d + \frac{d}{l} \right) = 2(1-d)\mathcal{H}(\boldsymbol{\…"/><img src="https://latex.codecogs.com/svg.image?%5Cdpi%7B150%7D%5Cbg_black%5Ccolor%7Bwhite%7D&space;G_c%20\left(%20-l%20\nabla^2%20d%20+%20\frac{d}{l}%20\right)%20=%202(1-d)\mathcal{H}(\boldsymbol{\epsilon})#gh-dark-mode-only" alt="G_c \left( -l \nabla^2 d + \frac{d}{l} \right) = 2(1-d)\mathcal{H}(\boldsymbol{\…"/></p>
...
*   **Exact Tensor Formulation:** Solves the dynamic elastic wave equation:
    ...
    <p align="center"><img src="https://latex.codecogs.com/svg.image?%5Cdpi%7B150%7D%5Cbg_white&space;\rho%20\frac{\partial^2%20\mathbf{u}}{\partial%20t^2}%20=%20\nabla%20\cdot%20\left(%20\mathbf{C}%20:%20\nabla^s%20\mathbf{u}%20\right)#gh-light-mode-only" alt="\rho \frac{\partial^2 \mathbf{u}}{\partial t^2} = \nabla \cdot \left( \mathbf{C}…"/><img src="https://latex.codecogs.com/svg.image?%5Cdpi%7B150%7D%5Cbg_black%5Ccolor%7Bwhite%7D&space;\rho%20\frac{\partial^2%20\mathbf{u}}{\partial%20t^2}%20=%20\nabla%20\cdot%20\left(%20\mathbf{C}%20:%20\nabla^s%20\mathbf{u}%20\right)#gh-dark-mode-only" alt="\rho \frac{\partial^2 \mathbf{u}}{\partial t^2} = \nabla \cdot \left( \mathbf{C}…"/></p>
...
*   **Exact Tensor Formulation:** Solves Herschel-Bulkley fluid dynamics where effective viscosity $\eta_{\text{eff}}$ scales with shear rate $\dot{\gamma}$:
    ...
    <p align="center"><img src="https://latex.codecogs.com/svg.image?%5Cdpi%7B150%7D%5Cbg_white&space;\tau%20=%20\tau_y%20+%20K%20\dot{\gamma}^n%20\quad%20\Longrightarrow%20\quad%20\eta_{\text{eff}}%20=%20\frac{\tau_y}{\dot{\gamma}}%20+%20K%20\dot{\gamma}^{n-1}#gh-light-mode-only" alt="\tau = \tau_y + K \dot{\gamma}^n \quad \Longrightarrow \quad \eta_{\text{eff}} =…"/><img src="https://latex.codecogs.com/svg.image?%5Cdpi%7B150%7D%5Cbg_black%5Ccolor%7Bwhite%7D&space;\tau%20=%20\tau_y%20+%20K%20\dot{\gamma}^n%20\quad%20\Longrightarrow%20\quad%20\eta_{\text{eff}}%20=%20\frac{\tau_y}{\dot{\gamma}}%20+%20K%20\dot{\gamma}^{n-1}#gh-dark-mode-only" alt="\tau = \tau_y + K \dot{\gamma}^n \quad \Longrightarrow \quad \eta_{\text{eff}} =…"/></p>
...
*   **Exact Tensor Formulation:** Implements a fully coupled residual function $\mathbf{F}(\mathbf{x}) = \mathbf{0}$ solved via a Jacobian-Free Newton-Krylov solver (`thmc_residual.rs` / `krylov_host.rs`):
    ...
    <p align="center"><img src="https://latex.codecogs.com/svg.image?%5Cdpi%7B150%7D%5Cbg_white&space;\mathbf{J}%20\mathbf{v}%20\approx%20\frac{\mathbf{F}(\mathbf{x}%20+%20\epsilon%20\mathbf{v})%20-%20\mathbf{F}(\mathbf{x})}{\epsilon}#gh-light-mode-only" alt="\mathbf{J} \mathbf{v} \approx \frac{\mathbf{F}(\mathbf{x} + \epsilon \mathbf{v})…"/><img src="https://latex.codecogs.com/svg.image?%5Cdpi%7B150%7D%5Cbg_black%5Ccolor%7Bwhite%7D&space;\mathbf{J}%20\mathbf{v}%20\approx%20\frac{\mathbf{F}(\mathbf{x}%20+%20\epsilon%20\mathbf{v})%20-%20\mathbf{F}(\mathbf{x})}{\epsilon}#gh-dark-mode-only" alt="\mathbf{J} \mathbf{v} \approx \frac{\mathbf{F}(\mathbf{x} + \epsilon \mathbf{v})…"/></p>
