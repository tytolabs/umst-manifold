...
use umst_manifold::runtime::gate::{
    ...
    LIVE_ATTESTATION_WIRED_HONEST, MANIFOLD_SEC_S6_GATE_WIRE_HOPS, SCERT_EXIT_NOT_WIRED,
    SCERT_UPSTREAM_SLOTS, S6_GREEN_CLAIM_BLOCKED, S6_INSPECT_FACTOR_COUNT,
    SEC_S6_BOARD_SLICE_ID, SEC_S6_EXPECTED_GATE_EXIT,
};
