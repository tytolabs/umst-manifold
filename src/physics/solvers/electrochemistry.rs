...
//!   (\(kl,ku\) from nearest-neighbour coupling). Each Newton **correction** **expands** the row band into a dense
//!   **\((3N)\times(3N)\)** scratch and runs host Gaussian elimination (**\(O((3N)^3)\)**;
